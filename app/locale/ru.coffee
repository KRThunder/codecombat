module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  new_home:
    ...
    quotes_quote1: "Назовите любую онлайн программу, я попробовал её. Ни один из них не соответствует CodeCombat. Любой учитель, который хочет, чтобы их ученики научились кодировать ... начните здесь!" # {change}
...
#    funding_resources_guide: "Funding Resources Guide"
  ...
  new_home_faq:
    ...
    python_and_javascript: "На данный момент мы поддерживаем Python и Javascript"
...
#    create_account_to_submit_multiplayer: "Create a free account to rank your multiplayer AI and explore the whole game!"
  ...
  common:
    default_title: "CodeCombat - Игра для изучения Python и JavaScript"
    default_meta_description: "Изучите написанный код с помощью игры по программированию. Изучите Python, JavaScript и HTML, решая головоломки и научитесь создавать свои собственные игры и веб-сайты для программирования."
  ...
  subscribe:
    ...
    year_price: "$__price__/год" # {change}
...
#    csr_title: "Customer Success Representative"
    ...
    bryukh_title: "Старший разработчик игрового процесса"
...
#    oi_title: "Online Instructor"
  ...
  courses:
    ...
    welcome_to_courses: "Искатели приключений, добро пожаловать на курсы!" # {change}
...
#    no_projects_published: "Be the first to publish a project in this course!"
    ...
    edit_project: "Редактиврование проекта"
  ...
  teacher:
    ...
    hoc_happy_ed_week: "Счвстливой недели изучения компьютерных наук!"
...
#    view_ai_league_team: "View AI League team"
    ...
    not_assigned_msg_1: "Чутобы добавить пользователю доступ к курсу он должен быть оплачен"
    ...
    select_license_type: "Выберите тип лицензии"
...
#    hoc_game_dev: "Game Development"
    hoc_and: "и"
    hoc_programming: "Программирование JavaScript/Python"
...
#    teacher_quest: "Teacher's Quest for Success"
    quests_complete: "Задание выполнено"
#    teacher_quest_create_classroom: "Create Classroom"
    teacher_quest_add_students: "Добавить студентов"
...
#    teacher_quest_keep_going: "Keep going! Here's what you can do next:"
    teacher_quest_more: "Просмотр всех заданий"
...
#    office_hours_detail_2: "sessions."
    ...
    mid_course: "Середина курса"
    end_course: "Окончание курса"
    none: "Не найден"
...
#    diplomat_introduction_url: "open source community"
    ...
    ambassador_join_step1: "Читать документацию."
    ambassador_join_step2: "Найди нас в ппубличном Slack канале."
#    ambassador_join_step3: "Help others in the Ambassador category."
  ...
  ladder:
    title: "Многопользовательские арены"
    arena_title: "__arena__ | Многопользовательские ареныs"
    ...
    tournament_starts: "Tурнир начинается"
...
#    continue_reading_blog: "Continue Reading on Blog..."
  ...
  loading_error:
    ...
    too_many_login_failures: "Превышено количество неуспешных попыток входа. Попробуйте снова позже."
...
#    unlimited_potential: "Our tournament structure is adaptable to any environment or use case. Students can participate at a designated time during regular learning, play at home asynchronously, or participate on their own schedule."
    ...
    join_team_name: "Вступить в Team __name__"
#    features: "Features"
